...
# покажи конверсию по стадиям сделок с человеческими названиями и сортировкой по полю sort и из воронок Продажа клиенту и Отгрузка. из истории движении сделок
